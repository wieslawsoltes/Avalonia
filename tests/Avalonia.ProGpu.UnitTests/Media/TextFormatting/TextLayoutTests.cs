...
namespace Avalonia.ProGpu.UnitTests.Media.TextFormatting
{
    public class TextLayoutTests
    {
        ...
        {
            const string symbolsFont = "resm:Avalonia.ProGpu.UnitTests.Fonts?assembly=Avalonia.ProGpu.UnitTests#Symbols";
            using (Start())
            {
        ...
        public void Should_Measure_TextLayoutSymbolWithAndWidthIncludingTrailingWhitespaceAndMinTextWidth()
        {
            using (Start())
            {
                const string monospaceFont = "resm:Avalonia.ProGpu.UnitTests.Assets?assembly=Avalonia.ProGpu.UnitTests#Noto Mono";
