    ...
    public class TextFormatterTests
    {
        ...
        public void Should_Wrap(string text, string familyName, int numberOfCharactersPerLine)
        {
            using (Start())
            {
                ...
                var typeface = new Typeface("resm:Avalonia.ProGpu.UnitTests.Assets?assembly=Avalonia.ProGpu.UnitTests#" +
                                            familyName);
            ...
            TextWrapping wrapping)
        {
            ...
            using (Start())
            {
                var typeface = new Typeface(FontFamily.Parse("resm:Avalonia.ProGpu.UnitTests.Fonts?assembly=Avalonia.ProGpu.UnitTests#DejaVu Sans"));
        ...
        public void Should_MatchCharacter_For_Spacing_CombiningMark()
        {
            using (Start())
            {
                ...
                var typeface = new Typeface(new FontFamily(new Uri("resm:Avalonia.ProGpu.UnitTests.Assets?assembly=Avalonia.ProGpu.UnitTests"), "Noto Mono"));
