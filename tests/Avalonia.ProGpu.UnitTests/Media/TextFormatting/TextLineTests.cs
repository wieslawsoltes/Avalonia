...
namespace Avalonia.ProGpu.UnitTests.Media.TextFormatting
{
    public class TextLineTests
    {
        ...
        public void Should_GetTextBounds_For_Mixed_Hidden_Runs_With_Ligature()
        {
            using (Start())
            {
                var typeface = new Typeface(FontFamily.Parse("resm:Avalonia.ProGpu.UnitTests.Fonts?assembly=Avalonia.ProGpu.UnitTests#Manrope"));
      ...
      formatter.FormatLine(textSource, 0, double.PositiveInfinity,
        ...
        {
            const string df7Font = "resm:Avalonia.ProGpu.UnitTests.Fonts?assembly=Avalonia.ProGpu.UnitTests#DF7segHMI";
        ...
        {
            const string symbolsFont = "resm:Avalonia.ProGpu.UnitTests.Assets?assembly=Avalonia.ProGpu.UnitTests#Source Serif";
        ...
        public void Should_Get_TextBounds_With_Mixed_Runs_Within_Cluster()
        {
            using (Start())
            {
                const string manropeFont = "resm:Avalonia.ProGpu.UnitTests.Fonts?assembly=Avalonia.ProGpu.UnitTests#Manrope";
        ...
        public void Should_Add_Half_LineGap_To_Baseline()
        {
            using (Start())
            {
                var typeface = new Typeface("resm:Avalonia.ProGpu.UnitTests.Fonts?assembly=Avalonia.ProGpu.UnitTests#Inter");
                var defaultProperties = new GenericTextRunProperties(typeface);
