...
namespace Avalonia.ProGpu.UnitTests
{
    public class ProGpuPackagingContractTests
    {
        ...
        public void IntegrationProjectsUseProGpuPackageIdsAndExactVersionPins()
        {
            ...
            Assert.Contains(">0.1.0-preview.12</ProGpuRuntimeVersion>", properties, StringComparison.Ordinal);
            Assert.Contains(">12.0.5-preview.12</ProGpuIntegrationVersion>", properties, StringComparison.Ordinal);
