...
namespace Avalonia.ProGpu.UnitTests
{
    public class ProGpuPackagingContractTests
    {
        ...
        public void IntegrationProjectsUseProGpuPackageIdsAndExactVersionPins()
        {
            ...
            Assert.Contains(">0.1.0-preview.4</ProGpuRuntimeVersion>", properties, StringComparison.Ordinal);
            Assert.Contains(">12.0.5-preview.4</ProGpuIntegrationVersion>", properties, StringComparison.Ordinal);
