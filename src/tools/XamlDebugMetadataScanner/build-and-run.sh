...
echo ""
echo "  # Analyze specific XAML file for control mapping:"
echo "  dotnet run -- --path \"$AVALONIA_ROOT/samples/Sandbox/bin/Debug/net8.0\" --xaml-file MainWindow.axaml"
echo ""
echo "  # XAML analysis with JSON output:"
echo "  dotnet run -- --path \"$AVALONIA_ROOT/samples/Sandbox/bin/Debug/net8.0\" --xaml-file MainWindow.axaml --json"
echo ""
